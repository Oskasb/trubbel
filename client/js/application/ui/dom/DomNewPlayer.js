...
import {DomCustomCharacter} from "./DomCustomCharacter.js";

class DomNewPlayer {
    constructor(onCloseCB, auto) {
        ...
        function customCharacter() {
            ...
            selectedCharacterId = "CUSTOM_CHARACTER"
            gtag('event', 'CUSTOM_CHARACTER', {
                "event_category": "PLAYER_START",
                "event_label": "INIT"
            });
            htmlElement.hideHtmlElement(1)
            new DomCustomCharacter(enterWorld, statusMap)
        }
        ...
        function update() {
            ...
            let readyCb = function() {
                ...
                let customCharButton = htmlElement.call.getChildElement('character_create_custom');
                ...
                DomUtils.addClickFunction(customCharButton, customCharacter)
