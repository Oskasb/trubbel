...
class EncounterStatus {
    constructor(id, worldEncId) {
        this.statusMap = {}
        this.statusMap[ENUMS.EncounterStatus.UPDATE_INDEX] = 0;
    ...
    setStatusKey(key, status) {
        ...
        if (MATH.stupidChecksumArray(this.statusMap[key]) !== MATH.stupidChecksumArray(status)) {
            this.statusMap[ENUMS.EncounterStatus.UPDATE_INDEX]++;
        }
