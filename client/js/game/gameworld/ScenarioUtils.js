...
function setupEncounterGrid(gridTiles, instances, gridConfig, posVec, forwardVec, minXYZ, maxXYZ, attachVisualBox) {
 ...
 //   console.log(gridConfig, gridWidth, gridDepth);
    ...
    for (let i = 0; i < gridWidth; i++) {
        ...
        for (let j = 0; j < gridDepth; j++) {
            ...
            dynamicTile.setTileIndex(x, z, i, j, attachVisualBox)
