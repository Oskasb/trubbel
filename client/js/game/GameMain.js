...
import {fetchConfigByEditId, getActiveVariations} from "../application/utils/ConfigUtils.js";
import {evt} from "../application/event/evt.js";
import {loadDndFromIndex} from "../application/utils/DndUtils.js";
import {DomNavTest} from "../application/ui/dom/nav/DomNavTest.js";
...
function activateLoadedPlayer() {
    ...
    GameAPI.getGamePieceSystem().initSpecialItems();
...
function startPlayerSession(auto) {
    new DomNewPlayer(activateNewPlayer, auto);
}
    ...
    initGameMain(auto) {
        ...
        if (isDev()) {
            ...
            function accCb(account) {
                    ...
                    setTimeout(function() {
                        ...
                        if (typeof (dataList[ENUMS.ActorStatus.CONFIG_ID]) !== 'string') {
                            ...
                            function testNavigation() {
                                domTransition.call.close();
                                new DomNavTest();
                                startPlayerSession(true)
                            }
                            ...
                            let opts = [
                                ...
                                {id:"button_ui_test", container:"bottom", text:"NAV TEST", onClick:testNavigation}
                            ]
                ...
                function structureLoaded(config) {
                    console.log("DND Structure Loaded", config);
                ...
                function indexLoaded(dndIndex) {
                    loadDndFromIndex(dndIndex, structureLoaded)
                }


                fetchConfigByEditId('dnd_index', indexLoaded);
