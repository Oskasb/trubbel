...
colorMapFx['LEAP_FX']               = {r:0.1,     g:0.5,   b:0.9,   a:0.6};
colorMapFx['VELOCITY_FX']           = {r:0.1,     g:0.4,   b:0.65,  a:0.2};
...
colorMapFx['FORCE_FX']              = {r:0.59,    g:0.45,  b:0.0,   a:0.5};
colorMapFx['GLITTER_FX']            = {r:0.4,     g:0.5,   b:0.6,   a:0.5};
colorMapFx['SMOKE_FX']              = {r:0.4,     g:0.3,   b:0.2,   a:0.4};
colorMapFx['ADVENTURE_HINT']        = {r:0.8,     g:0.7,   b:0.0,   a:0.2};
...
paletteMap['NATURE_FALL_2'] = {
    colors:{x:ENUMS.ColorCurve.grad_red_2, y:ENUMS.ColorCurve.grad_red_2, z: ENUMS.ColorCurve.grad_orange_1, w:ENUMS.ColorCurve.grad_green_2},
...
paletteMap['NATURE_FALL_LATE_2'] = {
    colors:{x:ENUMS.ColorCurve.grad_red_1, y:ENUMS.ColorCurve.grad_orange_1, z: ENUMS.ColorCurve.nearBlack, w:ENUMS.ColorCurve.grad_green_2},
    settings:{x:1, y:0.9, z: 1, w:-1.3}
};
...
paletteMap['NATURE_WINTER_2'] = {
    ...
    settings:{x:1, y:1.0, z: 1, w:0.0}
};
paletteMap['TOWN_RED'] = {
    colors:{x:ENUMS.ColorCurve.grad_red_1, y:ENUMS.ColorCurve.grad_orange_1, z: ENUMS.ColorCurve.grad_yellow_2, w:ENUMS.ColorCurve.grad_orange_1},
    settings:{x:1, y:0.9, z: 1, w:0.0}
};
paletteMap['TOWN_RED_2'] = {
    colors:{x:ENUMS.ColorCurve.grad_red_1, y:ENUMS.ColorCurve.grad_red_2, z: ENUMS.ColorCurve.grad_orange_1, w:ENUMS.ColorCurve.grad_red_2},
    settings:{x:1, y:0.9, z: 1, w:0.0}
};
paletteMap['TOWN_GREEN'] = {
    colors:{x:ENUMS.ColorCurve.grad_green_1, y:ENUMS.ColorCurve.grad_yellow_1, z: ENUMS.ColorCurve.grad_green_2, w:ENUMS.ColorCurve.grad_orange_1},
    settings:{x:1, y:0.8, z: 1, w:0.0}
};
paletteMap['TOWN_YELLOW'] = {
    colors:{x:ENUMS.ColorCurve.grad_orange_1, y:ENUMS.ColorCurve.grad_yellow_1, z: ENUMS.ColorCurve.grad_yellow_1, w:ENUMS.ColorCurve.grad_green_2},
    settings:{x:1, y:0.8, z: 1, w:0.0}
};
paletteMap['TOWN_NEUTRAL'] = {
    colors:{x:ENUMS.ColorCurve.grad_orange_1, y:ENUMS.ColorCurve.grad_yellow_3, z: ENUMS.ColorCurve.grad_yellow_3, w:ENUMS.ColorCurve.grad_green_2},
    settings:{x:1, y:0.9, z: 0.7, w:0.0}
};
paletteMap['TOWN_NEUTRAL_2'] = {
    colors:{x:ENUMS.ColorCurve.grad_orange_1, y:ENUMS.ColorCurve.grad_green_2, z: ENUMS.ColorCurve.grad_red_1, w:ENUMS.ColorCurve.grad_blue_2},
    settings:{x:1, y:0.9, z: 0.5, w:0.0}
};
paletteMap['TOWN_DARK'] = {
    colors:{x:ENUMS.ColorCurve.nearBlack, y:ENUMS.ColorCurve.grad_red_1, z: ENUMS.ColorCurve.grad_green_2, w:ENUMS.ColorCurve.nearBlack},
    settings:{x:1, y:0.8, z: 1.0, w:0.0}
};
paletteMap['TOWN_DARK_2'] = {
    colors:{x:ENUMS.ColorCurve.grad_grey, y:ENUMS.ColorCurve.grad_green_2, z: ENUMS.ColorCurve.grad_orange_1, w:ENUMS.ColorCurve.grad_blue_deep_1},
