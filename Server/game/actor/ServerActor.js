...
import {addItemToInventory, equipActorItem, getActorEquipmentStatusKey} from "../utils/EquipmentUtils.js";
...
class ServerActor {
    ...
    equipServerItem(serverItem, targetSlot) {
        console.log("equipServerItem", this.equippedItems, serverItem.id, targetSlot);
        ...
        //    console.log("Server Equip: to actor_id",serverItem.id, this.status.getStatus(ENUMS.ActorStatus.ACTOR_ID))
            ...
            console.log("MAX_HP post equip. ", this.getStatus(ENUMS.ActorStatus.MAX_HP))
